          ...
          <div id="letter">
            <div class="container">
              <div class="flip">
                ...
                <div class="back">
                  <p class="letter">
                    Ming<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;夜にはいつも寒いよね、でも、手を繋いでいると、暖かくなるよ！<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;どんなに寒い夜も、君と二人でいれば、ちっとも寒くない！<br /><br />
                  </p>
...
#music_btn2 {
  ...
  width: 32px;
  height: 32px;
  background: url(https://haiyong.site/demo/eluvletter/images/play.png)
    no-repeat;
  cursor: pointer;
  opacity: 0.2;
}
...
span {
  ...
  width: 150px;
  height: 150px;
  background: url(https://haiyong.site/demo/eluvletter/images/stitch.png)
    no-repeat;
...
section.container > form.flip > .back {
  ...
  box-shadow: inset 0 10px 30px -10px rgba(0, 0, 0, 0.3),
    inset 0 1px 0 rgba(0, 0, 0, 0.2), inset 0 2px 0 rgba(255, 255, 255, 0.2);
}
...
section.container > form.flip > .front {
  font-size: 1.25em;
  background: beige url('https://haiyong.site/demo/eluvletter/images/bg.png');
  background: url('https://haiyong.site/demo/eluvletter/images/bg.png')
      no-repeat 450px 20px,
    url('https://haiyong.site/demo/eluvletter/images/bg.png');
